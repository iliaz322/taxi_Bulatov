...
# Для разработки используем SQLite, для продакшена можно подключить PostgreSQL.
...
YANDEX_MAPS_API_KEY = os.getenv("YANDEX_MAPS_API_KEY", "dbf076d1-417e-495b-9cf1-d4b843cf6ec7")

LOGIN_URL = "users:login"
LOGIN_REDIRECT_URL = "rides:index"
LOGOUT_REDIRECT_URL = "rides:index"
